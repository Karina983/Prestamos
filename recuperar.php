...
$mensaje			= $enviarpass;
$tucorreo			= "From: copto3754@gmail.com";

if(mail($paracorreo,$titulo,$mensaje,$tucorreo))
{
	echo "<script> alert('Contraseña enviado');window.location= 'blog.html' </script>";
}else
{
	echo "<script> alert('Error');window.location= 'blog.html' </script>";
}
}
else
{
